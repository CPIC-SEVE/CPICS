...
<br>",
  vp_network = ">***J'ai toujours pensé que le réseautage est un pilier fondamental quand on cherche à se développer personnellement et professionnellement.***

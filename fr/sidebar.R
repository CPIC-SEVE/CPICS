cat('<div class="row">\n\n')
cat('<center><span> <p class="sidebar_logos">[<i class="fab fa-twitter"></i>](https://twitter.com/CPICSEVE)',
...
'<a href="https://www.instagram.com/cpics2023/"><i class="fa-brands fa-instagram" style="color: #00a300;"></i></a>', 
'</p></span></center>\n\n')
cat('<div class="row" style="margin: 1%">\n\n')
cat('<a href="http://centreseve.recherche.usherbrooke.ca/fr"><img src="images/logos/centre_seve.webp" alt="Centre SEVE logo" width="50%"></a><a href="http://www.frqnt.gouv.qc.ca/en/accueil"><img  src="images/logos/FRQNT_blanc(transparent).webp" width="50%"></a>\n\n')
cat('</div>\n\n')
